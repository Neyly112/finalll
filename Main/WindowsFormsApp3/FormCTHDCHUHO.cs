...
{
    public partial class FormCTHDCHUHO : Form
    {
        string ma;
        string maHD;
        string maPhong;
        ...
        public FormCTHDCHUHO(string ma, string maHD, string maPhong)
        {
            InitializeComponent();
            this.ma = ma;
            this.maHD = maHD;
        ...
        private void FormCTHDCHUHO_Load(object sender, EventArgs e)
        {
